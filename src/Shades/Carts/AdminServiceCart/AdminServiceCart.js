...
const AdminServiceCart = ({ product }) => {
  ...
  const handleDeleteProduct = (productID) => {
    ...
    setWating(true);
    fetch(`${process.env.REACT_APP_SERVER_HOST_URL}/services/delete_services/${productID}`, {
      method: "DELETE",
      headers: {
  ...
  return (
    <div className="admin-product-cart" id={product._id}>
      ...
      <div className="product-btn">
        <NavLink to={`/admin/services/eidt_service/${product._id}`}>
          <TbEdit />
          Edit
        </NavLink>

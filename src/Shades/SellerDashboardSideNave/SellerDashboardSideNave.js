    ...
    <>
      ...
      >
        ...
        <ul>
          ...
          {user.isActive && (
            <li>
              <NavLink to="/seller/sale-history">
                <GiHistogram />
          ...
          <li>
            ...
            >
              ...
              <ul>
                <li>
                  <NavLink to="/seller/balance_withdraw">
...
export default SellerDashboardSideNave;

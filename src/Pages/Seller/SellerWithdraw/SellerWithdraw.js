        ...
        <form autoComplete="off" className="card" onSubmit={formHandle}>
          ...
          <div className="common-form-select-container">
            ...
            <div className="select-input-common-style">
              ...
              <select>
                {withdrawInfo?.withdrawPoints && (
                  <option>{withdrawInfo.withdrawPoints * (2 / 100)} Tk</option>
                )}
              </select>
            </div>
          </div>
                ...
                <table>
                  <thead>
                    <tr>
                      ...
                      <th>Ammount Of TK</th>
                      <th>Ammount Of Tk</th>
                      <th>Charge on Daily Tk</th>
                      <th>Charge on Access Tk</th>
                      <th>Approve</th>
                      <th>Request Date</th>
                    </tr>
                  </thead>
                    ...
                    {user.dailyWithdroawHistory?.map((items, index) => {
                      return (
                        <tr key={items.requestID}>
                          ...
                          <td>{items.amountOfPoints} Tk</td>
                          <td>{items.amountOfTk} Tk</td>
                          <td>{items.dailyPointCharge} Tk</td>
                          <td>{items.accessPointCharge} Tk</td>
